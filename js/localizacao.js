...
const LocationPage = {
    ...
    storesData: [
        ...
        { nome: "Lojas Telex - Centro -  Campos dos Goytacazes", lat: -21.763614, lng: -41.323889, endereco: "Rua Treze de Maio, 262, loja 03, Centro, Campos dos Goytacazes/RJ, CEP 28010-260", imagem: "Imagens/LojasTelex/CdG.png", tipo: "telex" },
        ...
        { nome: "Telex - Tijuca - Rio de Janeiro", lat: -22.924854, lng: -43.232169, endereco: "Praça Saenz Pena, 45, loja 323, Shopping 45, Tijuca, Rio de Janeiro/RJ, CEP 20520-900", imagem: "Imagens/LojasTelex/tijuca.png", tipo: "telex" },
        { nome: "Phillips - Ipanema - Rio de janeiro", lat: -22.984508, lng: -43.205713, endereco: "Rua Visconde de Pirajá, 351, loja 207, Ipanema, Rio de Janeiro/RJ, CEP 22410-003.", imagem: "Imagens/Lojasphillips/ipa.png", tipo: "philips" },
        { nome: "Phillips - Tijuca - Rio de Janeiro", lat: -22.924928, lng: -43.231985, endereco: "Praça Saenz Peña, 45, loja 235, Tijuca, Rio de Janeiro/RJ, CEP 20520-090", imagem: "Imagens/LojasPhillips/tijuca.png", tipo: "philips" },
        { nome: "Phillips - Barra da Tijuca  - Rio de Janeiro", lat: -23.004274, lng: -43.317102, endereco: "Avenida das Américas, 500, bloco 9, loja 105, Barra da Tijuca, Rio de Janeiro/RJ, CEP 22640-904", imagem: "Imagens/LojasPhillips/barra.png", tipo: "philips" },
        ...
        { nome: "Phillips - Copacabana - Rio de Janeiro", lat: -22.970728, lng: -43.186757, endereco: "Avenida Nossa Senhora de Copacabana, 680, loja SS F, Copacabana, Rio de Janeiro/RJ, CEP 22050-900", imagem: "Imagens/LojasPhillips/copa.png", tipo: "philips" },
        { nome: "Phillips - Madureira - Rio de Janeiro", lat: -22.872898, lng: -43.338909, endereco: "Estrada do Portela, 99, loja 279, Madureira, Rio de Janeiro/RJ, CEP 21351-901", imagem: "Imagens/LojasPhillips/madu.png", tipo: "philips" },
     ...
     */
    setupMap() {
        const minhaApiKeyDaThunderforest = '0281d28b8bda43e1b9e6447aee1b238a'; // Mantenha a sua chave aqui

        const map = L.map('map', {
            center: [-22.92, -43.18], // Centralizado na Baía (entre Rio e Niterói)
            zoom: 11,                // Nível de zoom para enquadrar tudo
            scrollWheelZoom: false   
        });

        L.tileLayer(`https://{s}.tile.thunderforest.com/transport/{z}/{x}/{y}.png?apikey=${minhaApiKeyDaThunderforest}`, {
            attribution: 'Maps © <a href="http://www.thunderforest.com/">Thunderforest</a>, Data © <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',
            maxZoom: 19
        }).addTo(map);


        const greenIcon = this.createMarkerIcon('green');
        const goldIcon = this.createMarkerIcon('gold');

        this.storesData.forEach((store, index) => {
            const icon = store.tipo === "philips" ? goldIcon : greenIcon;
